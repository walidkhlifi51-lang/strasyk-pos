...
const LEGACY_ENTITY_FIELDS = {
  ...
  RestaurantProfile: [
    ...
    'web_ordering_flash_offer', 'web_ordering_horaires', 'web_ordering_closed', 'web_frais_livraison_enabled', 'web_frais_livraison',
    'scratch_tickets_enabled', 'bipeur_enabled', 'force_immediate_payment', 'allow_price_edit', 'allow_item_edit',
    'ai_image_generation_enabled', 'updated_date', 'created_date',
  ],
